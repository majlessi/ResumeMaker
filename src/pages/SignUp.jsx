          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                <form>
                  <Input label={'firstName'} name={'name'}  type={'text'} id={name} />
                  <Input label={'lastName'}  name={'fname'}  type={'text'} id={name} />
                  <Input label={'Email'} name={'email'}  type={'text'} id={name} />
                  <Input label={'Password'}  name={'password'} type={'text'} id={name} />
                  <Input label={'RePassword'}  name={'repassword'} type={'text'} id={name} />
